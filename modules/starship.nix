...

{
  ...
  settings = {
    ...
    status = {
      disabled = true;
      format =
        "[[$symbol$status_common_meaning$status_signal_name$status_maybe_int]](cyan bold dimmed)";
      map_symbol = true;
      pipestatus = true;
      symbol = "🔴";
    };
    ...
    conda = { symbol = " "; };
    dart = { symbol = " "; };
    docker_context = { format = "via [ $context](bold blue) "; };
    elixir = { symbol = " "; };
    elm = { symbol = " "; };
    git_branch = {
      symbol = " ";
    ...
    golang = { symbol = " "; };
    helm = { format = "via [ $version](bold purple) "; };
    hg_branch = { symbol = " "; };
    java = { symbol = " "; };
    julia = { symbol = " "; };
    kubernetes = {
    ...
    ruby = { format = "via [ $version]($style) "; };
    rust = { symbol = " "; };
    swift = { symbol = "ﯣ "; };
    vagrant = { format = "via [ vagrant $version]($style) "; };
  };
